  ...
  return (
    ...
    shadow-[0_25px_60px_rgba(0,0,0,0.7)]'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 items-start'>
            <motion.div
             ...
             style={{transformStyle: "preserve-3d"}}>
              <div className='flex items-center gap-3 curser-pointer'
                style={{transform:"translateZ(20px"}}>
                  <img src={logo} alt="logo"className="h-9 w-9 object-contain"/>
                  <span className="
                  text-lg font font-semibold
              ...
              <p className='text-sm text-gray-300 max-w-sm'>From Study Mode to Exam Mode — AI-Generated Notes, Diagrams & PDFs at Your Fingertips
              </p>

            </motion.div>

            <div className='text-center'>
              <h1 className='tet-sm font-semibold text-white mb-4'>Quick Links</h1>
          ...
          <div className='text-center'>
              <h1 className='tet-sm font-semibold text-white mb-4'>service & HelpCenter</h1> 
              <ul className='space-y-2 text-sm'>
                <li onClick={handleSignOut} className='text-red-400 hover:text-red-300 transition-colors'>Sign Out</li>
                <li onClick={()=>navigate("/pricing")} className='text-gray-300 hover:text-white transition-colors'>Add Credits</li>
        ...
        <p className='text-center text-xs text-gray-500'>
          © {new Date().getFullYear()} StudyAim AI. All rights reserved
        </p>
