...
const TopicForm = ({setResult, setLoading, loading, setError}) => {
  ...
  const [classLevel, setClassLevel] = useState(""); // which class
  const [examType, setExamType] = useState(""); // which exam
  ...
  return (
    ...
    ">
        ...
        text-white
        focus:outline-none focus:ring-2 focus:ring-white/30" placeholder='Enter Topic ( e.g. Web Developement )'
        ...
        placeholder='Class / Level ( e.g. B.Tech, MBA, Class 12 )'
        ...
        text-white
        focus:outline-none focus:ring-2 focus:ring-white/30"
         placeholder='Exam Type ( e.g. University, CBSE, ICSE, JEE, NEET )'
        ...
        onClick={handleSubmit}
            whileHover={!loading ? { scale: 1.01,  boxShadow: "0 12px 28px rgba(255,255,255,0.12)" } : {}}
        ...
        className={`
           ...
           ${
            loading
            ? "bg-gray-300 text-gray-600 cusor-not-allowed"
