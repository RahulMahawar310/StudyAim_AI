...
const FinalResult = ({ result }) => {
   const data = result?.data || result  // ✅ handles both cases safely
    ...
    <div className='mt-6 p-3 space-y-10 bg-white'>
      ...
      {result.diagram?.data && <section>
        ...
        <p className='mt-3 text-xs text-gray-500 italic'>
          ⬇️ If you need this diagram for future reference or revision purpose,
          you can save it by taking a screenshot.
        </p>

      </section>}

      { console.log("result.charts:", result.charts) }
     { console.log("full result:", result) }
      {result.charts?.length > 0 &&
        <section>
          ...
          <p className='mt-3 text-xs text-gray-500 italic'>
            ⬇️ If you need this charts for future reference or revision purpose,
            you can save it by taking a screenshot.
          </p>
      ...
      {result.charts && result.charts?.length === 0 && (
          <p className="text-sm text-gray-400 italic">
             📉 charts are at relvant for this topic.
          </p>
        )}
      ...
      <section>
        ...
        <p className='font-medium mt-4'>Long Question</p>
        <ul className='list-disc ml-6 text-gray-700'>
