  ...
  return (
    <div className='min-h-screen overflow-hidden bg-white text-black'>
          ...
          <div>
            <motion.div
              ...
              >
                ...
                From Chaos to Clarity <br/> Create AI Notes in a Flash..

                </motion.h1>

                <motion.p whileHover={{y: -1}}
                className='mt-6 max-w-xl text-lg
                bg-gradient-to-br from-gray-700 via-gray-500/80 to-gray-700
                bg-clip-text text-transparent'
                style={{
                  transform: "translateZ(10px)",
                  textShadow: "0 4px 10px rgba(0,0,0,0.10)",
                }}
                >
                  Create high-quality exam notes, project documentation, flow Charts, diagrams, and revision material quickly and efficiently using AI—organized, accurate, and easy to understand.
        ...
        <section className='max-w-6xl mx-auto px-8 py-32 grid grid-cols-1 md:grid-cols-4 gap-10'>
            <Feature icon="📘" title="Exam Notes" des="No more last-minute panic. Just clean, smart notes with revision points."/>
