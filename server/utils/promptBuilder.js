...
- If INCLUDE CHARTS is YES:
  ...
  - YOU MUST generate charts. This is MANDATORY.
  - charts array MUST have AT LEAST 2 chart objects
  - NEVER return empty charts array when Include Charts is YES
  - Failure to include charts = INVALID RESPONSE
  ...
  - value field MUST be a plain integer (e.g. 30), never a string (e.g. "30")
